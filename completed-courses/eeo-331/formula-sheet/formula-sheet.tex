...
\subsection{Schrodingers eq}

\subsection{Intrinsic Fermi Energy}


$$n_i^2 = N_c N_v \cdot e^{\frac{-Eg}{kT}}$$

Where:
\begin{itemize}
	\item $N_c = \SI{2.8e19}{cm^3}$ for Si
	\item $N_v = \SI{1.04e19}{cm^3}$ for Si 
